          ...
          <div className={styles.salePhotosAll}>
              ...
              <ul className={styles.salePhotosList}>
                <li className={styles.salePhotosItem}>
                  <img
                    ...
                    src="/img/sale-img/watch-5-min.png"
                    srcSet="/img/sale-img/watch-5-min.png 1x, ./img/sale-img/watch-5@2x-min.png 2x"
                    alt="watches"
                    width="52"
                  />
                </li>
                <li className={styles.salePhotosItem}>
                  <img
                    className={`${styles.img} ${styles.watchesFirst}`}
                    src="/img/sale-img/watch-4-min.png"
                    srcSet="/img/sale-img/watch-4-min.png 1x, ./img/sale-img/watch-4@2x-min.png 2x"
                    alt="watches"
                    width="52"
                  />
                </li>
                <li className={styles.salePhotosItem}>
                  <img
                    className={`${styles.img} ${styles.watchesFirst}`}
                    src="/img/sale-img/watch-2-min.png"
                    srcSet="/img/sale-img/watch-2-min.png 1x, ./img/sale-img/watch-2@2x-min.png 2x"
                    alt="watches"
                    width="52"
                  />
                </li>
                <li className={styles.salePhotosItem}>
                  <img
                    className={`${styles.img} ${styles.watchesFirst}`}
                    src="/img/sale-img/watch-3-min.png"
                    srcSet="/img/sale-img/watch-3-min.png 1x, ./img/sale-img/watch-3@2x-min.png 2x"
                    alt="watches"
                    width="52"
                  />
                </li>
            ...
            <div className={styles.bigPhoto}>
              <img
                ...
                src="/img/sale-img/watch-1-min.png"
                srcSet="/img/sale-img/watch-1-min.png 1x, /img/sale-img/watch-1@2x-min.png 2x"
                alt="watches"
                width="235"
              />
            </div>
