        ...
        <ul className={styles.revUl}>
          <li className={styles.revLi}>
            <picture>
              <source
                ...
                srcSet="/img/reviews-foto/John-min.jpg 1x, /img/reviews-foto/John2x-min.jpg 2x"
              />
              <source
              ...
              <img
                ...
                src="/img/reviews-foto/John-min.jpg"
                alt="John Wax"
              />
            </picture>
          ...
          <li className={`${styles.revLi} ${styles.liTablet}`}>
            <picture>
              <source
                media="(min-width: 1280px)"
                srcSet="/img/reviews-foto/Viktoria-min.jpg 1x, /img/reviews-foto/Viktoria2x-min.jpg 2x"
              />
              <source
                media="(min-width: 768px)"
                srcSet="/img/reviews-foto/Viktoria-min.jpg 1x, /img/reviews-foto/Viktoria2x-min.jpg 2x"
              ...
              <img
                className={styles.liImg}
                src="/img/reviews-foto/Viktoria-min.jpg"
          ...
          <li className={`${styles.revLi} ${styles.liDesktop}`}>
            <picture>
              <source
                media="(min-width: 1280px)"
                srcSet="/img/reviews-foto/Anastasia-min.jpg 1x, /img/reviews-foto/Anastasia2x-min.jpg 2x"
              />
              <source
                media="(min-width: 768px)"
                srcSet="/img/reviews-foto/Anastasia-min.jpg 1x, /img/reviews-foto/Anastasia2x-min.jpg 2x"
              ...
              <img
                className={styles.liImg}
                src="/img/reviews-foto/Anastasia-min.jpg"
